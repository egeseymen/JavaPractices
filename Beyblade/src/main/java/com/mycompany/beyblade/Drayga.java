...
public class Drayga extends Beyblade{
    ...
    public Drayga(String beybladesahibi, int donusHızı, int saldiriGucu,String kutsalCanavar) {
    ...
    public void kutsalcanavarortayaçıkar() {
        ...
        System.out.println(getBeybladesahibi()+" in Saldırısı: Kaplan Pençesi");
    }
